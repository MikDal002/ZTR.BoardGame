...
public class BoardGameService(IBoardGameStatusStorage boardGameStatusStorage, IAnsiConsole console, IGameStarter gameStarter, IResultSender resultSender, IServiceProvider serviceProvider) : IHostedService
{
    ...
    public Task StartAsync(CancellationToken cancellationToken)
    {
        ...
        _backgroundTask = MainGameLoop(cancellationTokenSource.Token);
